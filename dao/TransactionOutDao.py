...
from dao import SecretKeyDao, BlockchainDao, TransactionDao
...
def searchParentTransaction(txout):
    ...
    if tmp == None:
        ...
        parentTxId = tmp[0]
        return TransactionDao.searchByHash(parentTxId)